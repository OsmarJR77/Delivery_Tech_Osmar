...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    public LoginResponse login(LoginRequest loginRequest){
        ...
        catch (Exception e) { throw new RuntimeException("Credenciais inválidas", e); 
        }// fim do catch

    } // fim do login

    // -------- Espaço reservado para inserção de tokens na Blaclist  -------------------------------
    ...
    // -------- Método para buscar Usuario especifico - por ID ---------------------------------------
    ...
    } // fim do public usuario
   
} // fim class usuarioServiceImpl
